$(document).on('click','.InputAdmin',function(){
    ...
    function(data){
        ...
        if(data == '0'){
            ...
            window.location.href = "https://gsoft.ge/ImageUpload/admin.php"
        }
...
//            var sortedIDs = $( this ).sortable( "toArray",{attribute: 'data-id'});console.log(sortedIDs);
//         //    var sortedValue = $( this ).sortable( "toArray",{attribute:'data-value'});console.log(sortedValue);
//         //    var sortedCount = $( this ).sortable( "toArray",{attribute: 'data-count'});console.log(sortedCount);
//            var restid = $('#selectRestaurant').attr('value');
//         //    var hallid = dataid;
//            sortTableArray.push({'id':sortedIDs,'value':sortedValue, 'tablecount': sortedCount});
//            console.log(sortTableArray)
//         //    $.post( '/seatingspace',{ 'sortTableArray': sortTableArray, hallid: hallid, restid: restid});
...
function allowDrop(ev) {
  ...
  function drag(ev) {alert(ev.target.id)
